...
public class BlogController
{
    ...
    public String blogPostUodate(@PathVariable(value = "id") Long id,@RequestParam String title, @RequestParam String anons, @RequestParam String full_text, Model model)
    {
